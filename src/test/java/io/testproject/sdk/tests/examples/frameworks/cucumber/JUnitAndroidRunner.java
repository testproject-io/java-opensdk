...
/**
 * Example JUnit Cucumber Android test runner.
...
@CucumberOptions(features = "classpath:features/android_login.feature",
...
public final class JUnitAndroidRunner {

    /**
     * Default constructor.
     */
    private JUnitAndroidRunner() {
    ...
    public static void setUp() {
        System.out.println("Starting Android test feature run");
    }
